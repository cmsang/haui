...
WPF desktop app for **PCB inspection**: camera capture → OpenCV board segmentation → template regions → histogram-based region comparison (`MinMatchSimilarityPercent` in config, default 80%).
