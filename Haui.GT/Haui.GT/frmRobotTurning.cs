...
namespace Haui.GT
{
    public partial class frmRobotTurning : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Luu v? trí robot thành công!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void cboPos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Không th? t?i v? trí robot. Vui lòng ki?m tra l?i!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        {
            int changeValue = int.Parse(txtChangeValue.Text); // Giá tr? thay d?i, có th? di?u ch?nh theo nhu c?u
